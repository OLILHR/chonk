...
def mock_epitaxyignore_content():
    return [
        ".png",
        ".svg",
        "*.log",
...
@pytest.fixture(scope="function")
def mock_epitaxyignore(mock_epitaxyignore_content):
    return "\n".join(mock_epitaxyignore_content) + "\n"


@pytest.fixture(scope="function")
def mock_project(project_root, mock_epitaxyignore):
    files = {
        ...
        os.path.join(project_root, ".epitaxyignore"): mock_epitaxyignore,
    }
    return files
...
def mock_operations(monkeypatch, mock_project):
    ...
    def _mock_walk(top):
        ...
        for path in mock_project.keys():
            ...
            elif len(parts) == 1 and parts[0] != ".epitaxyignore":
    ...
    monkeypatch.setattr("epitaxy.utilities.tiktoken", mock_tiktoken)
